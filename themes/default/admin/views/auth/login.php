                            ...
                            <div class="col-sm-12">
                                <div class="textbox-wrap form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" value="demo@moxols.com" required="required" class="form-control" name="identity"
                                ...
                                <div class="textbox-wrap form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="password" value="12345678" required="required" class="form-control " name="password"
                                        placeholder="<?= lang('pw') ?>"/>
                                    </div>
                                </div>
                            </div>
